...
#ifndef HELPDEV_SWIFT_H
#define HELPDEV_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HelpDev",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7HelpDev11AppDelegate")
...
SWIFT_CLASS("_TtC7HelpDev19ForumViewController")
...
SWIFT_CLASS("_TtC7HelpDev18JavaViewController")
@interface JavaViewController : UIViewController
@property (nonatomic, strong) IBOutlet YTPlayerView * _Null_unspecified playerView;
...
SWIFT_CLASS("_TtC7HelpDev19LoginViewController")
...
SWIFT_CLASS("_TtC7HelpDev8PostCell")
...
SWIFT_CLASS("_TtC7HelpDev18PostViewController")
...
SWIFT_CLASS("_TtC7HelpDev9ReplyCell")
...
SWIFT_CLASS("_TtC7HelpDev13SceneDelegate")
...
SWIFT_CLASS("_TtC7HelpDev19SwiftViewController")
@interface SwiftViewController : UIViewController <YTPlayerViewDelegate>
@property (nonatomic, strong) IBOutlet YTPlayerView * _Null_unspecified playervView1;
@property (nonatomic, strong) IBOutlet YTPlayerView * _Null_unspecified playervView2;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
